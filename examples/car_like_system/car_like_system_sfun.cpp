...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  using StateSequence     = typename std::deque< teb::StateVertex<n_states>, Eigen::aligned_allocator<teb::StateVertex<n_states>> >;	
  using ControlSequence   = typename std::deque< teb::ControlVertex<n_controls>, Eigen::aligned_allocator<teb::ControlVertex<n_controls>> >;
  using ObstacleContainer = typename std::vector<teb::Obstacle*>;
