...
Eigen::MatrixXd Test<p,q>::getInfoFromText(std::string str)
{
   ...
   /*if(fileExists(_pws->pw_dir + _folder_simulation + str1) != true || fileExists(_pws->pw_dir + _folder_simulation + str2) != true
     || fileExists(_pws->pw_dir + _folder_simulation + str3) != true)
   {          
      return data;         
   }*/
