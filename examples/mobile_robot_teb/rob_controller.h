    ...
    public:
...
#else
        using TebController<3,0>::TebController; // inherite base constructors
#endif
        ...
        virtual void customOptimizationGraph()
        {
            ...
            for (unsigned int i=0; i<getN()-1; ++i)
            {
				...
				EdgeLimitVelocity* vel_edge = new EdgeLimitVelocity(_state_seq.at(i), _state_seq.at(i + 1), _dt);
