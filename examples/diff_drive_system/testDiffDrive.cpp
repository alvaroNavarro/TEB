...
int main()
{
   ...
   DifferentialDriveRobotSystem<n_state, n_control> robotSystem;
      
   robotSystem.setRobotDimension(0.9);
   
   // Setup solver and controller
    teb::SolverLevenbergMarquardtEigenSparse solver;
    teb::RobControllerDiffDrive<n_state, n_control> teb(&cfg, &solver);            
